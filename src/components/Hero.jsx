        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6 md:w-3/5">
              ...
              >
                MERN Stack Developer & AI enthusiast with strong DSA
                fundamentals, turning innovative ideas into intelligent,
              ...
              <motion.div variants={itemVariants} className="flex gap-4 pt-6">
                <a
                  href="https://drive.google.com/file/d/1aw9uDMG-DG7vYbOKInpDHzKnwrBXrjnU/view?usp=sharing"
                  target="_blank"
                >
                  <motion.button
