...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full bg-[#161716] text-white font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 text-center">
        ...
        <div className="w-full flex justify-center items-center">
          ...
          <p className=" text-sm md:text-base max-w-sm text-center">
            I&apos;ve been learning web development passionately for the past 3
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t  from-blue-600 via-indigo-700 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
